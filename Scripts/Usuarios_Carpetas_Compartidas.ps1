function Conect_database {
	...
	$ConnectionString = "server=" + "192.168.1.4" + ";port=3306;uid=" + "Proyecto" + ";pwd=$passwd" + ";database=INFO_CARPETAS_COMPARTIDAS"
...
$sql.CommandText = 'Log_Usuarios_Carpetas_Compartidas()'
