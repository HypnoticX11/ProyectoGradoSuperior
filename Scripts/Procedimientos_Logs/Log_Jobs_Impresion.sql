...
BEGIN
    ...
    SET @RUTA = concat("SELECT * FROM Cola_Impresión INTO OUTFILE '/opt/lampp/mysql/logs_Servicios/Impresion/Log_jobs_Impresion",DATE_FORMAT(NOW(),'_%Y_%m_%d_%H_%i_%s'), '.csv', "' FIELDS TERMINATED BY ','");
