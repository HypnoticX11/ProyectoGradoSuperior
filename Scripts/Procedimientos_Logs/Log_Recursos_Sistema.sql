...
BEGIN
    ...
    SET @RUTA = concat("SELECT * FROM Datos_Equipos INTO OUTFILE '/opt/lampp/mysql/logs_Servicios/Sistemas/Log_Datos_Equipos",DATE_FORMAT(NOW(),'_%Y_%m_%d_%H_%i_%s'), '.csv', "' FIELDS TERMINATED BY ','");
