...
BEGIN
    ...
    SET @RUTA = concat("SELECT * FROM Cola_Impresión INTO OUTFILE '/opt/lampp/mysql/logs_Servicios/Sistemas/Usuarios_Carpetas_Compartidas",DATE_FORMAT(NOW(),'_%Y_%m_%d_%H_%i_%s'), '.csv', "' FIELDS TERMINATED BY ','");
