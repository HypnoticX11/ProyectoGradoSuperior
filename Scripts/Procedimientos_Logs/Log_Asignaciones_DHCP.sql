...
BEGIN
    ...
    SET @RUTA = concat("SELECT * FROM IP_Asignadas INTO OUTFILE '/otp/lampp/mysql/logs_Servicios/DHCP/Log_Asgnaciones_DHCP",DATE_FORMAT(NOW(),'_%Y_%m_%d_%H_%i_%s'), '.txt ', "' FIELDS TERMINATED BY ','");
