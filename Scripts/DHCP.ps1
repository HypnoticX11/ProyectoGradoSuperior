...
foreach ($Ambito in $Ambitos) {
    ...
    $Opciones = Get-DhcpServerv4OptionValue -ComputerName 192.168.1.2 -ScopeID $Ambito.ScopeId
    ...
    $Reservas =  Get-DhcpServerv4Reservation -ComputerName 192.168.1.2 -ScopeID $Ambito.ScopeId
